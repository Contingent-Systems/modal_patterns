...
Exploiting similar design choices has been an important field of study.
...
Since . Kripke model is the model all program logics directly or indirectly, sits on. 
Kripke model can be roughly seen as a triple of set of worlds (e.g., program states), a binary relation between worlds (e.g., transition relations between states) and a state interpretation function.  
