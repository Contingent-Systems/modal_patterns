...
the current thread's assertions are evaluated), and evaluate a resource (an thread-local view of an address-value mapping) with respect to those other views. Although it looks like the pattern we see in the VMM case,
