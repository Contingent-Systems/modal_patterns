...
\paragraph{Weak-Memory} When considering weak memory models, we also want points-to information (address-value mappings) of thread-local views of events (an operationalization of the release-acquire + nonatomic
...
frames does not change its meaning. Regarding the definitions of weak-memory specific modalities existentially quantify over other views, related to the ``current'' view (the one where
