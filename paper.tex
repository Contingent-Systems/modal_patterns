...
leaves the memory layout in a form of DAG (directed acyclic graph) with a unique root, which resembles the first stack pointer referencing the allocated memory.
...
locally within each CPU core\footnote{This is a layer below the better-known L1 cache, which is coherent across all CPUs in the system.}
...
or what \emph{will be true after remote operations become visible locally}. Each of these flavors of contingent reasoning
...
\todo[inline,color=cyan]{I feel like we need citations here}
...
%GC-Modality &      & \multicolumn{2}{c}{\multirow{2}{*}{Because why not}} & 8                                   & & ~\cite{}\\
 ...
 Address-Space~\cite{kuru2024modalabstractionsvirtualizingmemory} &  [r]P     &   $\ell \mapsto v$ &  Weak                         &  Address-Space Switch  \\ 
