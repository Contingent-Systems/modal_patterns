...
\begin{document}
%
\title{Survey: Modal Verification Patterns for Systems}
%
...
the current thread's assertions are evaluated), and evaluate a resource (an thread-local view of an address-value mapping) with respect to those other views.
